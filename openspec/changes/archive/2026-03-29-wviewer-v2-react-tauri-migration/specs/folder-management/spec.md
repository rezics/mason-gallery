...
The application SHALL provide a button to clear the current folder selection and return to the empty state.

#### Scenario: Reset view
- **WHEN** the user clicks the refresh/reset button
