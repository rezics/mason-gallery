...
I think that image packs of any size should have uniform performance: first load them into an array, then render the view. If the metadata loading is slow, a loading animation should be displayed, instead of a black screen and a freeze.
Image metadata should be dynamically preloaded.
